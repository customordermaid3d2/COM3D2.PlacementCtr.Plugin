...
namespace COM3D2.PlacementCtr.Plugin
{
    internal static class PlacementCtrPatch
    {
        ...
        internal static MethodInfo onClick;
        ...
        {
            onClick = typeof(UIButton).GetMethod("OnClick", BindingFlags.Instance | BindingFlags.NonPublic);
        }
        ...
        {
            var btn = btns[UnityEngine.Random.Range(0, btns.Length - 1)];
            onClick.Invoke(btn, new object[] { });
